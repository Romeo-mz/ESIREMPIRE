...
createOrUpdateInfrastructureElement(infrastructure, parentDivId) {        
    ...
    if(infrastructure instanceof Installation) {
        ...
        if (infrastructure.cout_metal !== null) div_information_metal = this.createOrUpdateElement("div", `div-${prefix}-metal-ressource-${infrastructure.id}`, "div-infrastructure-metal", "Métal: " + infrastructure.cout_metal);
        if (infrastructure.cout_energie !== null) div_information_energie = this.createOrUpdateElement("div", `div-${prefix}-energie-ressource-${infrastructure.id}`, "div-infrastructure-energie", "Energie: " + infrastructure.cout_energie);
        if (infrastructure.cout_deuterium !== null) div_information_deuterium = this.createOrUpdateElement("div", `div-${prefix}-deuterium-ressource-${infrastructure.id}`, "div-infrastructure-deuterium", "Deuterium: " + infrastructure.cout_deuterium);
        if(infrastructure.production_metal !== null) div_production_metal = this.createOrUpdateElement("div", `div-${prefix}-production-metal-ressource-${infrastructure.id}`, "div-infrastructure-production-metal", "Production métal: " + infrastructure.production_metal * 60 + "/min");
        if(infrastructure.production_energie !== null) div_production_energie = this.createOrUpdateElement("div", `div-${prefix}-production-energie-ressource-${infrastructure.id}`, "div-infrastructure-production-energie", "Production énergie: " + infrastructure.production_energie * 60 + "/min");
        if(infrastructure.production_deuterium !== null) div_production_deuterium = this.createOrUpdateElement("div", `div-${prefix}-production-deuterium-ressource-${infrastructure.id}`, "div-infrastructure-production-deuterium", "Production deuterium: " + infrastructure.production_deuterium * 60 + "/min");
        ...
        div_information.appendChild(div_information_type);
        div_information.appendChild(div_information_level);
        if(infrastructure.cout_metal !== null) div_information.appendChild(div_information_metal);
        if(infrastructure.cout_energie !== null) div_information.appendChild(div_information_energie);
        if(infrastructure.cout_deuterium !== null) div_information.appendChild(div_information_deuterium);
        if(infrastructure.production_metal !== null) div_information.appendChild(div_production_metal);
        if(infrastructure.production_energie !== null) div_information.appendChild(div_production_energie);
        if(infrastructure.production_deuterium !== null) div_information.appendChild(div_production_deuterium);
        div_upgrade.appendChild(button_upgrade);
        div.appendChild(div_image);
        div.appendChild(div_information);
        div.appendChild(div_upgrade);
        ...
        if(infrastructure.cout_energie !== null)div_information_energie = this.createOrUpdateElement("div", `div-${prefix}-energie-defense-${infrastructure.id}`, "div-infrastructure-energie", "Energie: " + infrastructure.cout_energie);
