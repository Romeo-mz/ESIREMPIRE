...
class APIadmin
{
    ...
    private function sendResponse($statusCode, $statusText, $body = null)
    {
        ...
        if ($body != null) {
            ...
            echo "<script>window.location.href = 'http://esirloc/front/admin.php?success=1&message=" . urlencode($statusText) . "';</script>";
        } else {
            echo "<script>window.location.href = 'http://esirloc/front/admin.php?success=0&message=" . urlencode($statusText) . "';</script>";
        }
        exit;
    }
